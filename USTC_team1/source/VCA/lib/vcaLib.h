...
#define memc_enhanced_sad 1
#define memc_hor_only     0
#define fix_gop_sad       1
#define fps_early_termination 1
#define RDO_me   1
...
extern uint16_t g_img_width;
extern uint16_t g_img_height;
#endif

#if fix_gop_sad
extern bool g_memc_enable;
#endif
...
#if memc_enhanced_sad 
    std::array<uint32_t *, (filt_len)> energyPerBlockVerShift;
#endif
